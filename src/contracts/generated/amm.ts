...
export type DataKey = {tag: "Admin", values: void} | {tag: "Role", values: readonly [string]} | {tag: "Vault", values: void} | {tag: "Tokens", values: void} | {tag: "Collateral", values: void} | {tag: "Registry", values: void} | {tag: "Pool", values: readonly [u64]} | {tag: "PoolFee", values: readonly [u64]} | {tag: "LpBalance", values: readonly [u64, string]} | {tag: "NextPoolId", values: void} | {tag: "Paused", values: void};
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAEcG9vbAAAAAEAAAAAAAAAB3Bvb2xfaWQAAAAABgAAAAEAAAPpAAAH0AAAAAhQb29sRGF0YQAAB9AAAAAJRGlrZUVycm9yAAAA",
        ...
        "",
