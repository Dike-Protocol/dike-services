...
export type DataKey = {tag: "Admin", values: void} | {tag: "Role", values: readonly [string]} | {tag: "Balance", values: readonly [u64, string, Outcome]} | {tag: "Backing", values: readonly [u64]} | {tag: "Paused", values: void};
...
export interface Client {
  ...
  /**
   * Construct and simulate a backing transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  backing: ({market_id}: {market_id: u64}, options?: MethodOptions) => Promise<AssembledTransaction<i128>>

  /**
   * Construct and simulate a balance transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  balance: ({owner, market_id, outcome}: {owner: string, market_id: u64, outcome: Outcome}, options?: MethodOptions) => Promise<AssembledTransaction<i128>>
  ...
  /**
   * Construct and simulate a burn_losing transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  burn_losing: ({owner, market_id, outcome, amount}: {owner: string, market_id: u64, outcome: Outcome, amount: i128}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>

  /**
   * Construct and simulate a split_position transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  split_position: ({user, market_id, amount}: {user: string, market_id: u64, amount: i128}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>

  /**
   * Construct and simulate a burn_for_redeem transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  burn_for_redeem: ({owner, market_id, outcome, amount}: {owner: string, market_id: u64, outcome: Outcome, amount: i128}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>

  /**
   * Construct and simulate a merge_positions transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  merge_positions: ({user, market_id, amount}: {user: string, market_id: u64, amount: i128}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>

  /**
   * Construct and simulate a mint_complete_set transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  mint_complete_set: ({to, market_id, amount}: {to: string, market_id: u64, amount: i128}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>

  /**
   * Construct and simulate a transfer_position transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  transfer_position: ({from, to, market_id, outcome, amount}: {from: string, to: string, market_id: u64, outcome: Outcome, amount: i128}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAABQAAAAAAAAAAAAAABlBhdXNlZAAAAAAAAQAAAAVwYXVzZQAAAAAAAAEAAAAAAAAABnBhdXNlZAAAAAAAAQAAAAAAAAAA",
        "AAAAAgAAAAAAAAAAAAAAB0RhdGFLZXkAAAAABQAAAAAAAAAAAAAABUFkbWluAAAAAAAAAQAAAAAAAAAEUm9sZQAAAAEAAAARAAAAAQAAAAAAAAAHQmFsYW5jZQAAAAADAAAABgAAABMAAAfQAAAAB091dGNvbWUAAAAAAQAAAAAAAAAHQmFja2luZwAAAAABAAAABgAAAAAAAAAAAAAABlBhdXNlZAAA",
        "AAAABQAAAAAAAAAAAAAAB1JvbGVTZXQAAAAAAQAAAARyb2xlAAAAAgAAAAAAAAAEcm9sZQAAABEAAAABAAAAAAAAAAZtb2R1bGUAAAAAABMAAAAAAAAAAA==",
        "AAAABQAAAAAAAAAAAAAADlBvc2l0aW9uQnVybmVkAAAAAAABAAAABGJ1cm4AAAAEAAAAAAAAAAltYXJrZXRfaWQAAAAAAAAGAAAAAQAAAAAAAAAFb3duZXIAAAAAAAATAAAAAQAAAAAAAAAHb3V0Y29tZQAAAAfQAAAAB091dGNvbWUAAAAAAAAAAAAAAAAGYW1vdW50AAAAAAALAAAAAAAAAAE=",
AAAAAAAAAAAAAANX19jb25zdHJ1Y3RvcgAAAAAAAAEAAAAAAAAABWFkbWluAAAAAAAAEwAAAAA=",
        "AAAAAAAAAAAAAAAOc3BsaXRfcG9zaXRpb24AAAAAAAMAAAAAAAAABHVzZXIAAAATAAAAAAAAAAltYXJrZXRfaWQAAAAAAAAGAAAAAAAAAAZhbW91bnQAAAAAAAsAAAABAAAD6QAAA+0AAAAAAAAH0AAAAAlEaWtlRXJyb3IAAAA=",
        "AAAAAAAAAAAAAAAPYnVybl9mb3JfcmVkZWVtAAAAAAQAAAAAAAAABW93bmVyAAAAAAAAEwAAAAAAAAAJbWFya2V0X2lkAAAAAAAABgAAAAAAAAAHb3V0Y29tZQAAAAfQAAAAB091dGNvbWUAAAAAAAAAAAZhbW91bnQAAAAAAAsAAAABAAAD6QAAA+0AAAAAAAAH0AAAAAlEaWtlRXJyb3IAAAA=",
        "AAAAAAAAAAAAAAAPbWVyZ2VfcG9zaXRpb25zAAAAAAMAAAAAAAAABHVzZXIAAAATAAAAAAAAAAltYXJrZXRfaWQAAAAAAAAGAAAAAAAAAAZhbW91bnQAAAAAAAsAAAABAAAD6QAAA+0AAAAAAAAH0AAAAAlEaWtlRXJyb3IAAAA=",
        "AAAAAAAAAAAAAAARbWludF9jb21wbGV0ZV9zZXQAAAAAAAADAAAAAAAAAAJ0bwAAAAAAEwAAAAAAAAAJbWFya2V0X2lkAAAAAAAABgAAAAAAAAAGYW1vdW50AAAAAAALAAAAAQAAA+kAAAPtAAAAAAAAB9AAAAAJRGlrZUVycm9yAAAA",
        "AAAAAAAAAAAAAAARdHJhbnNmZXJfcG9zaXRpb24AAAAAAAAFAAAAAAAAAARmcm9tAAAAEwAAAAAAAAACdG8AAAAAABMAAAAAAAAACW1hcmtldF9pZAAAAAAAAAYAAAAAAAAAB291dGNvbWUAAAAH0AAAAAdPdXRjb21lAAAAAAAAAAAGYW1vdW50AAAAAAALAAAAAQAAA+kAAAPtAAAAAAAAB9AAAAAJRGlrZUVycm9yAAAA",
  ...
  public readonly fromJSON = {
    pause: this.txFromJSON<Result<void>>,
        backing: this.txFromJSON<i128>,
        balance: this.txFromJSON<i128>,
        set_role: this.txFromJSON<Result<void>>,
        burn_losing: this.txFromJSON<Result<void>>,
        split_position: this.txFromJSON<Result<void>>,
        burn_for_redeem: this.txFromJSON<Result<void>>,
        merge_positions: this.txFromJSON<Result<void>>,
        mint_complete_set: this.txFromJSON<Result<void>>,
        transfer_position: this.txFromJSON<Result<void>>
  }
}