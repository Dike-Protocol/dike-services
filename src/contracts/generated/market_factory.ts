...
export type DataKey = {tag: "Admin", values: void} | {tag: "Governance", values: void} | {tag: "Registry", values: void} | {tag: "Tokens", values: void} | {tag: "Vault", values: void} | {tag: "Amm", values: void} | {tag: "FeeManager", values: void} | {tag: "Creator", values: readonly [string]} | {tag: "Collateral", values: readonly [string]} | {tag: "MinLiquidity", values: void} | {tag: "MinExpiryDuration", values: void} | {tag: "NextMarketId", values: void} | {tag: "Market", values: readonly [u64]} | {tag: "Paused", values: void};
...
export interface Client {
  ...
  /**
   * Construct and simulate a market transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  market: ({market_id}: {market_id: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Result<MarketData>>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAABQAAAAAAAAAAAAAABlBhdXNlZAAAAAAAAQAAAAVwYXVzZQAAAAAAAAEAAAAAAAAABnBhdXNlZAAAAAAAAQAAAAAAAAAA",
        "",
        ...
        "AAAAAAAAAAAAAAAGbWFya2V0AAAAAAABAAAAAAAAAAltYXJrZXRfaWQAAAAAAAAGAAAAAQAAA+kAAAfQAAAACk1hcmtldERhdGEAAAAAB9AAAAAJRGlrZUVycm9yAAAA",
  ...
  public readonly fromJSON = {
    pause: this.txFromJSON<Result<void>>,
        market: this.txFromJSON<Result<MarketData>>,
