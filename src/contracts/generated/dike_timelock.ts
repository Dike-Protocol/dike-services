...
export interface Client {
   ...
   */
  queue: ({kind, target, payload_hash, requested_delay}: {kind: TimelockActionKind, target: string, payload_hash: Buffer, requested_delay: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Result<u64>>>
   ...
   */
  execute: ({action_id, payload_hash}: {action_id: u64, payload_hash: Buffer}, options?: MethodOptions) => Promise<AssembledTransaction<Result<TimelockAction>>>
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAgAAAAAAAAAAAAAAB0RhdGFLZXkAAAAABwAAAAAAAAAAAAAABUFkbWluAAAAAAAAAAAAAAAAAAAIUHJvcG9zZXIAAAAAAAAAAAAAAAhFeGVjdXRvcgAAAAAAAAAAAAAACE1pbkRlbGF5AAAAAAAAAAAAAAALR3JhY2VQZXJpb2QAAAAAAAAAAAAAAAAMTmV4dEFjdGlvbklkAAAAAQAAAAAAAAAGQWN0aW9uAAAAAAABAAAABg==",
        ...
        "AAAAAAAAAAAAAAAFcXVldWUAAAAAAAAEAAAAAAAAAARraW5kAAAH0AAAABJUaW1lbG9ja0FjdGlvbktpbmQAAAAAAAAAAAAGdGFyZ2V0AAAAAAATAAAAAAAAAAxwYXlsb2FkX2hhc2gAAAPuAAAAIAAAAAAAAAAPcmVxdWVzdGVkX2RlbGF5AAAAAAYAAAABAAAD6QAAAAYAAAfQAAAACURpa2VFcnJvcgAAAA==",
        ...
        "AAAAAAAAAAAAAAAHZXhlY3V0ZQAAAAACAAAAAAAAAAlhY3Rpb25faWQAAAAAAAAGAAAAAAAAAAxwYXlsb2FkX2hhc2gAAAPuAAAAIAAAAAEAAAPpAAAH0AAAAA5UaW1lbG9ja0FjdGlvbgAAAAAH0AAAAAlEaWtlRXJyb3IAAAA=",
